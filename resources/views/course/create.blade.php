            ...
            <div>
                <form method="POST" action="{{ route('course.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <textarea class="form-control col-sm-10{{ $errors->has('description')?' is-invalid':'' }}" name="description" id="description">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <select class="form-control col-sm-10" name="category_id">
                            ...
                            <option value="{{ $category->id }}"<?php if(old('category_id') == $category->id) echo ' selected'; ?>> 
                                    {{ $category->title }} 
                                </option>
                            @endforeach    
                        </select>
