...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div>
                <form method="POST" action="{{ route('category.update', ['primaryKeyValue' => $item->id])}}">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <textarea class="form-control col-sm-10" name="description" id="description">{{ old('description',$item->description) }}</textarea>
                    </div>
                    <div class="row">&nbsp;</div>
                    <div class="row">
